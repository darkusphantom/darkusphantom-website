  ...
  return (
    <div className="aboutme__content info__description container">
      <p>
        ...
        <strong>Marca Personal</strong>.<br /> En cada objetivo que me propongo,
        busco superarme. Quiero sacar la mejor version mi, tanto a nivel
        personal como profesional, y alcanzar mis metas mientras impulso,
        inspiro y motivo, a otros, con lo que aprendo y mis experiencias.
      </p>
    </div>
  );
};
